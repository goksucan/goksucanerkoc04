package com.lello.gokkucan.rrscan.Adapter
...
import com.lello.gokkucan.rrscan.Interface.ItemClickListener
...
class FeedViewHolder(itemView: View):RecyclerView.ViewHolder(itemView),View.OnClickListener, View.OnLongClickListener
{
   ...
   private var itemClickListener : ItemClickListener?=null
    init{
        txtTitle = itemView.findViewById<TextView>(R.id.txtTitle) as TextView
        txtPubdate = itemView.findViewById<TextView>(R.id.txtPubdate) as TextView
        txtContent = itemView.findViewById<TextView>(R.id.txtContent) as TextView
